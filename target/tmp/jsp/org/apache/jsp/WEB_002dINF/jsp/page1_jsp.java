...
public final class page1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        .navbar .navbar-nav > li > a:hover, .navbar-default .navbar-nav > li > ul\r\n");
      out.write("        {\r\n");
      out.write("            color:white;/*color turns white if not changed*/\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        .dropdown-menu > li > a:hover, .dropdown-menu > li > a:focus {\r\n");
      out.write("            /* Set the highlight color of the dropdown menu items (when a user hovers over the menu item) */\r\n");
      ...
      out.write("            /* Permalink - use to edit and share this gradient: http://colorzilla.com/gradient-editor/#001e4a+0,0273d4+99       */\r\n");
      out.write("            background: #001e4a; /* Old browsers */\r\n");
      out.write("            background: -moz-linear-gradient(top, #001e4a 0%, #0273d4 99%); /* FF3.6-15 */\r\n");
      out.write("            background: -webkit-linear-gradient(top, #001e4a 0%, #0273d4 99%); /* Chrome10-25,Safari5.1-6 */\r\n");
      out.write("            background: linear-gradient(to bottom, #001e4a 0%, #0273d4 99%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */\r\n");
      ...
      out.write("            /* Permalink - use to edit and share this gradient: http://colorzilla.com/gradient-editor/#0e0e0e+0,7d7e7d+100 */\r\n");
